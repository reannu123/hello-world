...
function Skills() {
  return (
    <div className="my-auto items-center justify-center text-center md:flex mx-16">
      ...
      <div>
        {/* desktop */}
        <h1 className="font-Comfortaa font-bold text-center text-teal-800 dark:text-teal-300 max-md:hidden md:text-[6vh] md:whitespace-nowrap lg:text-8xl mb-2 mt-4 lg:mb-4 lg:mt-8 lg:mx-[5vw] select-none">
          Skills
        </h1>
      </div>
      <div className="">
